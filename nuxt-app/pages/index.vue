  ...
  <div class="bg-slate-800">
    ...
    <div class="container p-4 mx-auto text-white md:text-lg">
      ...
      <div>
        ...
        <NuxtLink class="w-fit p-4 flex flex-col items-center bg-slate-800 border-4 border-emerald-400 rounded-lg hover:bg-emerald-400 hover:shadow-[0_0_15px_rgba(74,222,128,0.6)] md:text-2xl lg:text-3xl text-white hover:text-black transition-all duration-300" to="/resume">
